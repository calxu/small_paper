...
def learnModel(dtrain, deval):
    ...
    # training
    bst = xgb.train(params, dtrain, 500, watchlist, early_stopping_rounds=None)
...
def main():
    """ Train and test. """
    # Training
    dtrain, deval = readFeatures("./2_baseline_features/trainFeatures_merge")
    ...
    # Testing
    dtest = readFeatures("./2_baseline_features/testFeatures_merge")
