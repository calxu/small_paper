...
"""
Task: Sort users id according time zone firstly. During the same time zone, sort location zone according distance shortest principle.
Author: Calvin,Xu.
"""
...
def clusterTimeZone(data, timeGranularity):
    ...
    data.sort(order=("time", "latitude", "longitude"))  # sort according checkins time
